...
test('lookupPoint answers an address entry only inside the box asked for', async () => {
  ...
  assert.equal(await g.lookupPoint('ITPL Main Road, Whitefield, Bengaluru, Karnataka, India', { south: 12.92, west: 77.6, north: 12.956, east: 77.646 }), null); // outside Koramangala
