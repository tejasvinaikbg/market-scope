 ...
 * inside the city, a re-run asks about nobody, a miss is recorded as not found, and the market read counts it all.
 */
...
test('the three stores without coordinates are located inside the city; the seven uploaded ones are untouched', async () => {
  ...
  assert.deepEqual(r, { total: 3, located: 3, notFound: 0, errors: 0 });
