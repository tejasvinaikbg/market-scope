...
interface Session {
  ...
  setPortfolio: (p: CurrentPortfolio | null) => void;
  market: CurrentMarket | null;
  setMarket: (m: CurrentMarket | null) => void;
}
...
export const useCurrentPortfolio = () => {
  const { portfolio, setPortfolio } = useContext(SessionContext);
...
export const useCurrentMarket = () => {
  const { market, setMarket } = useContext(SessionContext);
